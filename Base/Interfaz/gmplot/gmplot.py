...
class GoogleMapPlotter(object):
    ...
    def write_points(self, f):
        ...
        for point in self.points:
            self.write_point(f, point[0], point[1], point[2], point[3], cont)
            cont = cont + 1
    ...
    def write_point(self, f, lat, lon, color, title, num):
        ...
        f.write('\t\t{\n')
        f.write('\t\tmap.setZoom(18);\n')
        f.write('\t\tmap.setCenter(marker%d.getPosition());\n' % (num))
        f.write('\t\t});\n')
        f.write('\n')
